...
// Create Product
app.openapi(Post({ path: "/product/craete", tags: ["Product"], middleware: [checkVendor], schema: ProductPostSchema }), productControllers().newProduct);
// Get All product
app.openapi(Get({
    path: "/product/get",
    query: z.object({
...
// Edit product
app.openapi(Patch({ path: "/product/edit", query: z.object({ id: z.string() }), tags: ["Product"], middleware: [checkVendor], schema: ProductPostSchema }), productControllers().updateProduct);
// Delete product
