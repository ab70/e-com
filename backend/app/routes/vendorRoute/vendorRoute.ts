...
// Create Vendor
app.openapi(Post({ path: "/vendor/craete", tags: ["Vendor"], middleware: [checkAdmin], schema: VendorPostSchema }), vendorControllers().newVendor);
// Get all vendor
...
// Edit vendor
app.openapi(Patch({ path: "/vendor/edit", query: z.object({ id: z.string() }), tags: ["Vendor"], middleware: [checkVendor], schema: VendorPostSchema, }), vendorControllers().updateVendor);
// Delete vendor
